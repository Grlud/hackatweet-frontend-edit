...
function Home() {
  ...
  useEffect(() => {
    ...
    fetch(`https://grlud-hackatweet-backend-334562763631.us-central1.run.app/tweets/all/${user.token}`)
  ...
  const handleSubmit = () => {
    fetch('https://grlud-hackatweet-backend-334562763631.us-central1.run.app/tweets', {
      method: 'POST',
